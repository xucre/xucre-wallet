const values = {
  ...
  LegacySendTransaction: {
    ...
    approve_button: 'Aprobay',
    from :'Kaymanta: ',
    header: 'Transacción firma',
    reject_button: 'Qhipachay',
    title: 'Transacción  kachay',
    to: 'Kay: '
  },
  LegacySignTransaction: {
    ...
    header: 'Transacción firma',
    reject_button: 'Qhipachay',
    title: 'Transacción firma'
  },
  LegacySignTypedData: {
    approve_button: 'Aprobay',
    header: 'Willakuy mañakuy firmay',
    header_origin: 'Qallariy: ',
    reject_button: 'Qhipachay',
    title: 'Willakuy firma'
  },
  Listener: {
    failure_message: 'Transacción mana atisqachu',
    success_message: 'Transacción Allinmi'
  },
  Menu: {
  ...
  QRReader: {
    ...
    permission_request: 'Kamaramanta permisota mañakuy',
    rescan: 'Hukmanta escanear ñit\'iy'
  },
    QRWallet: {
    instructions: 'Qullqita chaskinapaq rakinakuy'
  },
  RecoverWallet: {
    instructions: 'Ama hina kaspa, ñawpaq billetera ruwayniykimanta mnemónicos nisqap qatiqninta qillqay.',
  ...
  SetPassword: {
    form_confirmation: 'Contraseñata takyachiy',
  ...
  TokenItem: {
    menu_accessiblity_label: "Aswan akllanakuna menú",
